...
module.exports = class Dokdo {
   ...
   */
  constructor (client, { owners = null, secrets = [], noPerm, disableAttachmentExecution = false, globalVariable = {}, isOwner = undefined } = {}) {
    ...
    this.client = client
    this.process = []
    this.options = { secrets, noPerm, disableAttachmentExecution, isOwner }
